...
function Dump-Blob($dbFile) {
    ...
    Write-Output "=== Blob strings for $dbFile ==="
...
Dump-Blob "46cf95ba-2a42-498a-85fc-90c849dcd2ba.db"
Dump-Blob "c65c70e4-1473-4c30-bb91-f17f7cbd18d7.db"
